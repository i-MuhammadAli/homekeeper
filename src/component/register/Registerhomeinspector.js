...
function Registerhomeinspector() {
    ...
    const sendDetailsToServer = async () => {
        ...
        formdata.append('type', "homeinspector");
        ...
        axios.post("https://admin.myhomekeeper.co/api/homekeeperregister", formdata)
            .then(function (response) {
                ...
                if (response.data.status == 'success') {
                    ...
                    localStorage.setItem('token-type', "homeinspector")
        ...
        <section className="login register lenderReg">
            <div className="container">
                ...
                <form className="text-start" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <h1>Register as Home Inspector</h1>
                    <div className="form-signin">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" placeholder="Enter full name" {...register("name", { required: "Name Field is Required" })} onChange={handleChange} />
                            ...
                            {setnameerror ? <span className='errormessage'>{setnameerror}</span> : ""}
                        </div>

                        <div className="form-group">
                            <label className="st">Company Name<span>*</span>:</label>
                            <input type="text" name="company" className="form-control" placeholder="Enter company name" {...register("company", { required: "Company field is Required" })}
                                value={state.company}
                        ...
                        <div className="form-group">
                            ...
                            <input type="email" className="form-control" placeholder="Enter email address" name="email" {...register("email", { required: "Email field is Required" })}
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control inputnumber" placeholder="Enter mobile number" name="phone" {...register("phone", { required: "Phone Number is Required" })}
                        ...
                        <div className="form-group">
                            ...
                            <span className="password d-block">
                                ...
                                <input type={viewpassword ? "text" : "password"} id="password" className="form-control" placeholder="Password" name="password" {...register("password", { required: "Password Field is required" })}
                            ...
                            {errorforpasswordcombination ? <span className="errormessageforlogin">{errorforpasswordcombination}</span> : ""}
                        </div>
                        <div className="form-group">
                            <label className="st">Confirm Password <span>*</span>: </label>
                            <span className="password d-block">
                                <input type={viewpassword1 ? "text" : "password"} id="confirmPassword" className="form-control" placeholder="Password"
                            ...
                            {errorforconfirmpassowrd ? <><span className='errormessage'>{errorforconfirmpassowrd && errorforconfirmpassowrd !== '' ? errorforconfirmpassowrd : ""}</span><br /></> : ""}
                            {Errorforempty1 && Errorforempty1 !== '' ? <><span className="errormessageforlogin">{Errorforempty1}</span></> : ""}
                            
                            {errorforpasswordcombination1 ? <span className="errormessageforlogin">{errorforpasswordcombination1}</span> : ""}
     ...
     <input type="file" className="form-control" placeholder="Cell number" onChange={handleChange} />
                        ...
                        <div className="form-group">
                            ...
                            <div className="checkbox">
                                <label className="mt-0"><input type="checkbox" checked={checkedbox} className='checkboxclick' onClick={checkboxclick} value="remember-me" />
...
export default Registerhomeinspector;
