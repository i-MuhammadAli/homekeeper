  ...
  const onSubmit = async (data) => {
    ...
    if (data.password == data.confirmPassword) {
      if (data.password.length >= 7) {
        ...
        setErrorforconfirmpassword("Password Should atleast 6 character Long");
      }
    } else {
      ...
      api
        ...
        .then(function (response) {
          ...
          if (response.data.status == "success") {
            ...
            localStorage.setItem("token-type", "lender");
          ...
          <form className="text-start" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-signin">
              ...
              <div className="form-group">
                ...
                <ErrorMessage
                  ...
                  render={({ message }) => (
                    <>
                      {messageforemail ? (
                        <span className="errormessage">{messageforemail}</span>
                      ) : (
                        ""
                      )}
                    </>
              ...
              <div className="form-group">
                ...
                {Errorforempty1 ? (
                  <span className="errormessageforlogin">{Errorforempty1}</span>
                ) : (
                  ""
                )}
                ...
                <p className="mb-0">
                  *Optional to add your Profit & Upload up to 5 MB
                </p>
              </div>
              ...
              <div className="form-group">
                ...
                <div className="input-group custom-file-button">
                  <span className="input-group-text" for="inputGroupFile">
                    Choose
                  </span>
                  <input
                    type="file"
            ...
            <div className="row mt-4">
              <div className="col-sm-6">
                <p className="mt-0">
                  ** Contrary to popular belief, Lorem lpsum is not simply
                  random text.
                  <br />
