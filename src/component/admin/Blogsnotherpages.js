        ...
        <section className="dashboard">
            <div className="container-fluid">
                ...
                <div className="inspection_reques button_pages">
                    <h2> <a className="filter" href="#"><i className="fa-solid fa-filter"></i><i className="fa-solid fa-xmark"></i></a> Blog and Other Pages</h2>
