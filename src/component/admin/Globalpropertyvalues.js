...
function Globalpropertyvalues() {
    ...
    const handledeleteclick=(id)=>{
        ...
        axios.post("https://admin.myhomekeeper.co/api/homekeeperdeleteglobalpropertylist",formdata)
        .then(function(response) {

            if (response.data.status == 'success') {

                console.log("delete successfully")
                setstatefordeleteproperty("Property List Deleted Successfully")
                sendDetailsToServer();
            }
    ...
    //display all globalproperty value
    const sendDetailsToServer = async () => {

        axios.post("https://admin.myhomekeeper.co/api/homekeeperglobalpropertylist")
            .then(function (response) {
...
// add property value
    const addDetailstoServer = () => {
        ...
        axios.post("https://admin.myhomekeeper.co/api/homekeeperaddglobaldata", formdata)
            .then(function (response) {
...
// update property value
    const updatetemplate=(e)=>{
        ...
        axios.post("https://admin.myhomekeeper.co/api/homekeeperupdateglobaldata", formdata)
            .then(function (response) {
                console.log('response', response.data);
                if (response.data.status == 'success') {
                    const message1 = response.data.message;
        ...
        <section className="dashboard">
            <div className="container-fluid">
                ...
                <div className="inspection_reques maintenance globalpropertyvalues">
                    {insertmessage}
                    <h2><a className="filter" href="#"><i className="fa-solid fa-filter"></i><i className="fa-solid fa-xmark"></i></a>Global Property Values
